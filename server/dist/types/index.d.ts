...
export type AuditAction = 'LOGIN' | 'LOGOUT' | 'PASSWORD_CHANGE' | 'ROLE_CHANGE' | 'ATTENDANCE_UPDATE' | 'MARKS_UPDATE' | 'RECORD_CREATE' | 'RECORD_UPDATE' | 'RECORD_DELETE' | 'ADMIN_ACTION';
export type ReportType = 'ATTENDANCE' | 'MARKS' | 'STUDENT_PERFORMANCE' | 'FEE_COLLECTION' | 'FACULTY_WORKLOAD' | 'COURSE_COMPLETION' | 'OTHER';
